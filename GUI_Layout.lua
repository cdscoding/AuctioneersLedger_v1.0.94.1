...
function AL:UpdateButtonStates()
    ...
    if AL.currentActiveTab == AL.VIEW_WARBAND_STOCK then
        visibleSortButtons = {self.SortAlphaButton, self.SortCharacterButton, self.SortRealmButton, self.SortBagsButton, self.SortBankButton, self.SortReagentBankButton, self.SortWarbandBankButton, self.SortMailButton, self.SortAuctionButton}
...
function AL:UpdateLayout()
    ...
    if self.LeftPanel then
        ...
        local allButtons = {
            ...
            self.SortRealmButton, self.SortBagsButton, self.SortBankButton, self.SortReagentBankButton, 
            self.SortWarbandBankButton, self.SortMailButton, self.SortAuctionButton, self.SortLimboButton
        }
        ...
        if AL.currentActiveTab == AL.VIEW_WARBAND_STOCK then
            ...
            table.insert(buttonStructure, {type = "button", ref = self.SortBagsButton}); table.insert(buttonStructure, {type = "button", ref = self.SortBankButton}); table.insert(buttonStructure, {type = "button", ref = self.SortReagentBankButton}); table.insert(buttonStructure, {type = "button", ref = self.SortWarbandBankButton}); table.insert(buttonStructure, {type = "button", ref = self.SortMailButton}); table.insert(buttonStructure, {type = "button", ref = self.SortAuctionButton})
        elseif AL.currentActiveTab == AL.VIEW_AUCTION_FINANCES or AL.currentActiveTab == AL.VIEW_VENDOR_FINANCES then
