...
function AL:CreateFrames()
    ...
    self.SupportMeButton = AL.createLeftPanelButton(lp, "SupportMe", "Support Me", function() AL:ToggleSupportWindow() end, false, frameNameSuffix)
    ...
    self.SortReagentBankButton = AL.createLeftPanelButton(lp, "SortReagentBank", "Reagent Bank First (Flat)", AL.SORT_REAGENT_BANK, true, frameNameSuffix)
    self.SortWarbandBankButton = AL.createLeftPanelButton(lp, "SortWarbandBank", "Warband Bank First (Flat)", AL.SORT_WARBAND_BANK, true, frameNameSuffix)
    ...
    local headerFrame=CreateFrame("Frame","AL_ColumnHeaderFrame" .. frameNameSuffix,self.MainWindow)
    self.ColumnHeaderFrame=headerFrame
    -- [[ BUG FIX: Added the missing BackdropTemplateMixin to the header frame ]]
